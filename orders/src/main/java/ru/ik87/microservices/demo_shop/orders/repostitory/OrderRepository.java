...
public interface OrderRepository extends CrudRepository<Order, Long> {
    List<Order> findAllByClientIdAndStatus(Long clientId, OrderStatus status);
    ...
    void deleteByClientIdAndOrderIdAndStatusIn(Long clientId, Long orderId, Collection<OrderStatus> orderStatusCollection);
}
